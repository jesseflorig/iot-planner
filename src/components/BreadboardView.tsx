      ...
      >
        ...
        {allModuleLayouts.map(({ layout, mod, inst }) => (
          <g key={layout.moduleId}>
            ...
            />
            <text x={layout.x + layout.width / 2} y={layout.y + 14} textAnchor="middle" fill="#a1a1aa" fontSize={9}>
              {mod.name}
            </text>
            {inst.status === 'error' && (
              <text x={layout.x + layout.width / 2} y={layout.y + 26} textAnchor="middle" fill="#f59e0b" fontSize={8}>
